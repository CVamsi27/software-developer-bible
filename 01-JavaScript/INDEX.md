...
| # | File | Topics |
|---|------|--------|
| 01 | [Execution Context](01-Execution-Context.md) | GEC vs FEC, creation/execution phases, scope chain |
| 02 | [Call Stack](02-Call-Stack.md) | LIFO, stack frames, stack overflow, maximum call stack |
...
**Cross-references:** [TypeScript](../02-TypeScript/) | [Node.js](../05-NodeJS/) | [Coding Patterns](../19-Coding-Patterns/)
---

## Navigation

[← Previous: Interview Strategy](../00-Interview-Strategy/INDEX.md) · [🏠 Back to Index](../INDEX.md) · [Next: TypeScript →](../02-TypeScript/INDEX.md)

...
> **12 files** — Database fundamentals from PostgreSQL internals to indexing, transactions, MVCC, joins, locking, connection pooling, Prisma, execution plans, and interview questions.
...
**Cross-references:** [REST APIs](../07-REST-API/) | [System Design](../11-System-Design/) | [Performance Monitoring](../26-Performance-Monitoring/)
---

...
│  ❌ Highlighting: 30% retention                                │
│  ❌ Practice problems: 50% retention                           │
...
│                                                                 │
│  Level 1: AWARENESS                                            │
│  ✅ Can recognize the pattern when you see it                  │
...
│  ❌ Can't solve under time pressure                           │
│  📊 Pass rate: 50%                                             │
│                                                                 │
│  Level 3: APPLICATION                                          │
│  ✅ Can solve independently                                    │
│  ✅ Can solve under time pressure (25 min)                    │
│  ❌ Can't teach it clearly                                     │
│  📊 Pass rate: 70%                                             │
│                                                                 │
│  Level 4: MASTERY                                              │
│  ✅ Can solve quickly (< 20 min)                               │
│  ✅ Can teach it clearly                                       │
...
| Pattern | Min Level | Test | Time Limit | Pass Criteria |
|---------|-----------|------|------------|---------------|
| Two Pointers | Level 4 | Solve 3 problems from memory | 15 min each | 2/3 correct, clean code |
| Sliding Window | Level 4 | Solve 3 problems from memory | 15 min each | 2/3 correct, clean code |
| Binary Search | Level 4 | Solve 3 problems from memory | 15 min each | 2/3 correct, clean code |
| Trees DFS/BFS | Level 4 | Solve 3 problems from memory | 15 min each | 2/3 correct, clean code |
| Graph BFS/DFS | Level 4 | Solve 3 problems from memory | 15 min each | 2/3 correct, clean code |
| Dynamic Programming | Level 4 | Solve 3 problems from memory | 20 min each | 2/3 correct, optimal |
| System Design | Level 4 | Design a system in 45 min | 45 min | Complete design, trade-offs |
...
1. Pattern Name: _______________
   When to use: _______________

2. Template/Code Skeleton:
   _________________________________________________
   _________________________________________________
   _________________________________________________

3. Key Problems:
   - Problem 1: _______________ (LC #___)
   - Problem 2: _______________ (LC #___)
   - Problem 3: _______________ (LC #___)
...
FROM MEMORY (before looking at solution):

1. What's the brute force approach?
   _________________________________________________
...
4. What edge cases do I need to handle?
   _________________________________________________

5. Write the code from memory:
   _________________________________________________
   _________________________________________________
   _________________________________________________
...
1. Start with a simple analogy:
   "This pattern is like _______________ because _______________"

2. Explain when to use it:
   "You should use this when _______________"

3. Walk through the template:
   "First, you _______________, then you _______________"

4. Give an example:
   "For example, if you have _______________..."
...
3. Name 3 problems that use this pattern
...
SCORING:
- 3/3 correct, clean code, optimal = MASTERY
...
| Date | Topic | Activity | Duration | Mastery Level | Notes |
|------|-------|----------|----------|---------------|-------|
| ___/___ | | ☐ Learn ☐ Practice ☐ Recall ☐ Teach ☐ Test | ___min | L1/L2/L3/L4/L5 | |
...
☐ _______________ (Level 4+)
☐ _______________ (Level 4+)
☐ _______________ (Level 4+)
☐ _______________ (Level 4+)

PROBLEMS SOLVED: ___
MASTERY TESTS PASSED: ___/___
MOCK INTERVIEWS COMPLETED: ___

OVERALL MASTERY PROGRESS: ___%
...
│ Graphs          │ ___/5     │ ⬆️/➡️/⬇️ │
│ DP              │ ___/5     │ ⬆️/➡️/⬇️ │
│ System Design   │ ___/5     │ ⬆️/➡️/⬇️ │
│ Behavioral      │ ___/5     │ ⬆️/➡️/⬇️ │
└─────────────────┴───────────┴──────────┘

OVERALL READINESS: ___/10

INTERVIEW READY CHECKLIST:
☐ All topics at Level 4+
...
│                                                                 │
│   ┌──────────┐                                                  │
│   │  LEARN   │ ←── Read, understand, take notes                │
│   └────┬─────┘                                                  │
│        │                                                        │
│        ▼                                                        │
│   ┌──────────┐                                                  │
│   │ PRACTICE │ ←── Solve 3-5 problems                          │
│   └────┬─────┘                                                  │
│        │                                                        │
│        ▼                                                        │
│   ┌──────────┐                                                  │
│   │  RECALL  │ ←── Test from memory, no notes                  │
│   └────┬─────┘                                                  │
│        │                                                        │
│        ▼                                                        │
│   ┌──────────┐                                                  │
│   │  TEACH   │ ←── Explain out loud, record yourself           │
│   └────┬─────┘                                                  │
│        │                                                        │
│        ▼                                                        │
│   ┌──────────┐                                                  │
│   │   TEST   │ ←── Solve NEW problems under pressure           │
│   └────┬─────┘                                                  │
│        │                                                        │
│        ▼                                                        │
│   ┌──────────┐                                                  │
...
1. Pattern Recognition
   ...
   Back: "When array is sorted or finding pairs with specific condition"

2. Code Templates
   Front: "Write Binary Search template"
   Back: [Code skeleton]

3. Problem Patterns
   Front: "LC #146 - LRU Cache - What pattern?"
   Back: "HashMap + Doubly Linked List, O(1) get/put"
...
3. Give a mock behavioral answer
4. Review and score yourself (1-10)
...
## ✅ The Learning Guarantee Checklist
...
☐ Can solve under time pressure (< 20 min)
...
### Rate Yourself (1-10) on Each Topic

| Topic | Confidence | Can Solve | Can Teach | Ready? |
|-------|------------|-----------|-----------|--------|
| Arrays & Strings | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Two Pointers | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Sliding Window | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Binary Search | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Linked Lists | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Stacks & Queues | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Trees | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Heaps | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Graphs | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Dynamic Programming | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| System Design | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |
| Behavioral | __/10 | ☐ Yes ☐ No | ☐ Yes ☐ No | ☐ |

**TOTAL SCORE: ___/120**

**Interpretation:**
- 100-120: 🟢 **Ready to interview**
- 80-99: 🟡 **Almost there, focus on weak areas**
- 60-79: 🟠 **Keep working, not ready yet**
